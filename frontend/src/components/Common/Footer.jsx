  ...
  return (
    <footer className="border-t border-gray-200 py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <p className="text-gray-500 mb-4">
            Be the first to hear about new products, exclusive events, and onlne
            offers.
          </p>
          <p className="font-medium text-sm text-gray-600 mb-6">Sign up and get 10% off your frst order.</p>
          {/* Newsletter form */}
          <form className="flex">
            <input
              type="email"
            ...
            hover:bg-yellow-600 transition-all">Subscribe</button>
          </form>
        </div>
        {/* Shop links */}
      ...
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
         <p className="text-gray-500 text-sm tracking-tighter text-center">&copy;2025, Eagle. All Rights Reserved.<span className="text-red-700 text-lg h-4 w-5">&#9829;</span></p>
      </div>
    </footer>
  );
};
